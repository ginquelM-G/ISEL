package yamd.g13.pdm.leic.isel.yamd.control.notification
...
/**
 * Helper class for showing and canceling follow movie
 * notifications.
 *
 *
 ...
 */
object FollowMovieNotification {
    /**
     * The unique identifier for this type of notification.
     */
    private val NOTIFICATION_TAG = "FollowMovie"
     ...
     * presentation of follow movie notifications. Make
     * sure to follow the
     * [
 * Notification design guidelines](https://developer.android.com/design/patterns/notifications.html) when doing so.
    ...
    fun notify(context: Context,
        ...
        val title = res.getString(
                R.string.follow_movie_notification_title_template, exampleString)
        val text = res.getString(
                R.string.follow_movie_notification_placeholder_text_template, exampleString)
        ...
        val builder = NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_follow_movie)
